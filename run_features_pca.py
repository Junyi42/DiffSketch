...
def main():
    ...
    blocks = exp_config.config.blocks
    ...
    print(f"visualizing features PCA experiments: block - {exp_config.config.blocks}; transform experiments - {exp_config.config.experiments_transform}; fit experiments - {exp_config.config.experiments_fit}")
    ...
    for t in iterator:
        for feature_type in feature_types:
            for block in blocks:
                ...
                fit_features = load_experiments_features(fit_feature_maps_paths, block, feature_type, t)  # N X C
                transform_features = load_experiments_features(transform_feature_maps_paths, block, feature_type, t)
